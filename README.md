...
Functionality: **_Uses camel-jetty to copy this github page to file_**
...
git clone https://github.com/jammazwan/xaq_JettyHttpToFile.git
cd jammazwan.shared
mvn install 
```
...
_run XaqTest to examine file generated_
...
so you can focus only on what is required to demo the **JettyHttpToFile** feature **_in isolation_**.
...
The prefix **xaq** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
