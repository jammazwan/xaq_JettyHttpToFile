...
Functionality: **_Uses camel-jetty to copy wired.com to file_**
...
Git clone the xaq_JettyHttpToFile project into your workspace:
...
cd xaq_JettyHttpToFile
mvn install -DskipTests

```

You man now import xaq_JettyHttpToFile into your IDE.
